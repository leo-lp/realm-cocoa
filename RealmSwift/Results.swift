 ...
 */
public final class Results<T: RealmManaged>: NSObject, NSFastEnumeration where T: NSObject {

    internal let rlmResults: RLMResults<NSObject>
    ...
    internal init(_ rlmResults: RLMResults<NSObject>) {
